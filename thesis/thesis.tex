...
\renewcommand{\gSupervisor}{Dr.-Ing. Merih Seran Uysal \\
	M. Sc. Marco Pegoraro}
...
\renewcommand{\gSubDate}{2020-11-24}
...
\newcommand{\cheading}[1]{\multicolumn{1}{C}{#1}}
\newcommand{\heading}[1]{\multicolumn{1}{X}{#1}}
