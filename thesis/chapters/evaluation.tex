...
\begin{figure}[!htbp]
	...
	\begin{subfigure}{\textwidth}
		...
		\begin{tikzpicture}[scale=0.9]
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Outcome accuracy and cycle time MAE on the job application event log.}
		\vspace{0.3cm}
	\end{subfigure}
	\begin{subfigure}{\textwidth}
		\centering
		...
		\begin{tikzpicture}[scale=0.9]
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Outcome accuracy and cycle time MAE on the customer journey event log.}
		\vspace{0.3cm}
	\end{subfigure}
	\begin{subfigure}{\textwidth}
		\centering
