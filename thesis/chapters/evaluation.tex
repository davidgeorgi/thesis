...
The prediction accuracy is improved on the hospital admission log by up to 3.01 percentage points using the BoW model and a 500 dimensional text encoding compared to the LSTM baseline.
	...
	\begin{subfigure}{\textwidth}
		...
		\begin{tikzpicture}[scale=0.9]
			\begin{axis}[
				...
				\addplot table[x=index,y=oaBoW50, col sep= comma] {data/prefix_application.csv};
				\addlegendentry{BoW}
				...
				\addlegendentry{PV}
				\addplot table[x=index,y=oaLDA10, col sep= comma] {data/prefix_application.csv};
				\addlegendentry{LDA}
	...
	\begin{subfigure}{\textwidth}
		...
		\begin{tikzpicture}[scale=0.9]
			\begin{axis}[
				...
				\addlegendentry{PV}
				\addplot table[x=index,y=oaLDA20, col sep= comma] {data/prefix_admissions.csv};
				\addlegendentry{LDA}
