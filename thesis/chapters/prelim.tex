...
An input instance in the supervised scenario is usually described by a set of \textit{feature variables} $X$ and the output is defined by a \textit{target variable} $y$.
