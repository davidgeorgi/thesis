...
To derive a mathematical representation of textual data that can be interpreted by learning algorithms, a text model has to be applied using the whole text corpus.
...
\end{equation*}
LSTM networks can backpropagate a more stable error with this gating mechanism, such that these networks are much more capable of learning complex functions for sequences compared to standard recurrent neural networks.
