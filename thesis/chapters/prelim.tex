...
The output of the sublayers are computed with the following equations:
...
The new cell state $C_t$ is then a combination of the old cell state $C_{t-1}$ and the result of the update gate $\bar{C}_t$, where the layer computations $f_t$ and $i_t$ determine the proportions.
